 ...
 * estructura multiboot que recibe del GRUB*/
...
void cmain(unsigned int magic, void * multiboot_info) {
	 ...
	 *
	 * En esta variable recibe una estructura de datos con toda la informaicion
	 * de cuando el GRUB carga, contiene informacion de El numero magico,
	 * las banderas que pasan del GRUB para solicitar informacion y/o servicios,
	 * informacion de la direccion de donde se encuentra el encabezado dentro del
	 * KERNEL, la informacion de donde se encuentra el KERNEL, y hasta donde
	 * llega la memoria asignada para el, la direccion del BSS, y la direccion
	 * en la cual se debe pasar el control al KERNEL.
	 * */
